...
public class MinMax extends MinMaxAbstract {
     ...
     */
    private int max(Board board, int depth, int player) {
        if (depth == 0 || board.getBilles(1).size() == 8 || board.getBilles(2).size() == 8) {
